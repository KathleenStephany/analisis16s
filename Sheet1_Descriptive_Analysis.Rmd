...
```{r}
miseq_path = "/home/analisis16/data/Demultiplexed"
...
```{r}
#Esto tarda pero si es necesario para otra compu
#errF <- learnErrors(filtFs, multithread=TRUE)
#errR <- learnErrors(filtRs, multithread=TRUE)

errF <- saveRDS(errF,"test_objects/Sheet1/errF.rds")
errR <- saveRDS(errR,"test_objects/Sheet1/errR.rds")

errF <- readRDS("objects/Sheet1/errF.rds")
errR <- readRDS("objects/Sheet1/errR.rds")
...
```{r, warning = FALSE, fig.align='center'}
errF <- readRDS("/home/user42/analisis16/objects/Sheet1/errF.rds")
errR <- readRDS("/home/user42/analisis16/objects/Sheet1/errR.rds")
