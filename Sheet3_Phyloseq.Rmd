...
meta <- meta(ps1) # Metadata se puede explorar cada informacion de estos imprimiendo
...
reads_sample <- readcount(ps1) # Total read counts se puede modificar
sample_data(ps1)$reads_sample <- reads_sample # Reads per sample
meta(ps1)

df <- psmelt(ps1) # tablas para paper
kable(head(df))
...
```{r, include = FALSE}
filterPhyla2 <- c("Chloroplast", "Mitochondria", "Eukaryota") # observar uno por uno y ver cuantos se van clasificando
...
# ver de todas las maneras para imprimir en ggplot imprimir de un renglon mas para ver como sale al final
...
#https://www.youtube.com/@redmexicanabioinformatica7106
